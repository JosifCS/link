...
const dialogVariants = cva(
	"fixed z-50 flex flex-col w-full gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:rounded-lg",
	{
		variants: {
			position: {
			...
			size: {
				...
				full: "max-w-[calc(100%-15px)] h-[calc(100%-15px)] md:max-w-[calc(100%-24px)] md:h-[calc(100%-24px)] lg:max-w-[calc(100%-80px)] lg:h-[calc(100%-80px)]",
			},
		},
		defaultVariants: {
			position: "center",
